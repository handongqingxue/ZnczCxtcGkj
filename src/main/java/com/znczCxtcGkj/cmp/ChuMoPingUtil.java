...
import com.znczCxtcGkj.util.ByteUtil;
import com.znczCxtcGkj.util.HexadecimalUtil;
import com.znczCxtcGkj.util.RXTXUtil;
...
public class ChuMoPingUtil {
	...
	public static String getCRC(String str) {
        ...
        byte[] bytes = ByteUtil.hex2byte(str);
        int CRC = 0x0000ffff;
	...
	public static void main(String[] args) {
		...
		//https://blog.csdn.net/qq_44761778/article/details/127442867?spm=1001.2101.3001.6650.2&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EAD_ESQUERY%7Eyljh-2-127442867-blog-82852351.pc_relevant_3mothn_strategy_and_data_recovery&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EAD_ESQUERY%7Eyljh-2-127442867-blog-82852351.pc_relevant_3mothn_strategy_and_data_recovery&utm_relevant_index=5
		//https://blog.csdn.net/qq_41755287/article/details/82852351?spm=1001.2101.3001.6650.5&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-5-82852351-blog-105537082.pc_relevant_3mothn_strategy_and_data_recovery&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-5-82852351-blog-105537082.pc_relevant_3mothn_strategy_and_data_recovery&utm_relevant_index=8
		/*
		String str0=HexadecimalUtil.get16Num(getVarNumBySf("港"));
		System.out.println("str0==="+str0);
		String str=ADDRESS+FUN_CODE+LOC_HIGHT+"00"+VAR_HIGHT+str0+"49D2";
		System.out.println("str==="+str);
		SerialPort serialPort = RXTXUtil.openSerialPort("COM7", 9600);
		RXTXUtil.sendData(serialPort,str);
		*/
		byte[] b = "020300000040".getBytes();
		String s = getCRC("020300000040");
