...
public class ReadBangFangJdqSocket implements Runnable {

	private Socket client;
	BangFangJdq bangFangJdq;
	private int BUFFER_SIZE = 50;
	
	public ReadBangFangJdqSocket(Socket socket, BangFangJdq bangFangJdq) {
		// TODO Auto-generated constructor stub
		client = socket;
		this.bangFangJdq=bangFangJdq;
	}
						...
						if(size>-1) {
							...
							if(data.substring(0,4).equals("EEFF")) {
					            ...
					            if(state1=='1'){
					                ...
					                bangFangJdq.setKgl1Open(true);
					            }
					            else { 
					            	System.out.println("开关量1:已断开"); 
									bangFangJdq.setKgl1Open(false);
					            }
					            ...
					            if(state2=='1'){
					                ...
					                bangFangJdq.setKgl2Open(true);
					            }
					            else { 
					                System.out.println("开关量2:已断开");
						            bangFangJdq.setKgl2Open(false);
					            }
					            ...
					            if(state3=='1'){
					                ...
					                bangFangJdq.setKgl3Open(true);
					            }
					            else { 
					                System.out.println("开关量3:已断开");
						            bangFangJdq.setKgl3Open(false);
					            }
					            ...
					            if(state4=='1'){
					                ...
					                bangFangJdq.setKgl4Open(true);
					            }
					            else { 
					                System.out.println("开关量4:已断开");
						            bangFangJdq.setKgl4Open(false);
					            }
							}
						}
						else {
